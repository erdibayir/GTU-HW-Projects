...
For n= 0 $a_0$ = $c_1$ - 2 = 1 \newline
$c_1$ = 3 \newline
5)  $a_n$ $(general)$ = 3.$3^{n}$ - 2.$2^{n-1}$ =$3^{n+1}$ - 2.$2^{n-1}$  \newline
...
$a_n$ $(g)$ = $a_n$ $(h)$ + $a_n$ $(p)$ \newline
2)$a_n$ $(h)$ =  7$a_{n-1}$ - 16$a_{n-2}$ + 12$a_{n-3}$ \newline
3)we assume that $a_{n-3}$ = 1 , $a_{n-2}$ =r , $a_{n-1}$ = $r^2$ and $a_{n}$ = $r^3$ \newline
4) $r^3$ = 7$r^2$ - 16r + 12 \newline
$r^3$ - 7$r^2$ + 16r - 12 =0\newline
$(r-2)$ $^2$.$(r-3)$ =0 \newline
$r_1$ =3 , $r_2$ =2 and $r_3$ =2 \newline
5)$a_n$ $(h)$ = $c_1$ $3^n$ + $c_2$ $2^n$ + $c_3$ $2^n$.n \newline
6)For  $a_n$ $(p)$ \newline
we assume that $a_n$ $(p)$ = $(A.n + B)$ .$4^n$ \newline
$a_{n-1}$ = $(A.(n-1) + B)$ .$4^(n-1)$ \newline
$a_{n-2}$ = $(A.(n-2) + B)$ .$4^(n-2)$ \newline
$a_{n-3}$ = $(A.(n-3) + B)$ .$4^(n-3)$ \newline
 $(A.n + B)$ .$4^n$ = 7$(A.(n-1) + B)$ .$4^(n-1)$ -16$(A.(n-2) + B)$ .$4^(n-2)$ +12 $(A.(n-3) + B)$ .$4^(n-3)$ + n.$4^n$ \newline
 if we solve this equation we get that;\newline
 A = 16 and B = -80 \newline
 $a_n$ $(p)$ = $(16.n -80)$ .$4^n$ \newline
 7) $a_n$ $(g)$ = $c_1$ $3^n$ + $c_2$ $2^n$ + $c_3$ $2^n$.n + $(16.n -80)$ .$4^n$ \newline
 for n=0 \newline
 $c_1$ + $c_2$ -80 = -2 \newline
 for n=1 \newline
 3.$c_1$ + 2.$c_2$ + 2.$c_3$ -256 = 0 \newline
 for n= 2 \newline
 9.$c_1$ + 4.$c_2$ +8.$c_3$ -768 =5 \newline
 if we calculate this three equation we find  $c_1$ $c_2$ $c_3$ \newline
 $c_1$ = 61 $c_2$ = 39/2 and  $c_3$ =17 \newline
 8)$a_n$ $(g)$ = $61$. $3^n$ + $39/2$. $2^n$ + $17$. $2^n$.n + $(16.n -80)$ .$4^n$ \newline
