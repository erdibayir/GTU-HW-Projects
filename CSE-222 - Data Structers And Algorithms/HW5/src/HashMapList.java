 ...
 * @author Erdi Bayır
 * @since 12.05.2021
 * Hash Map Class using Linked Lists to chain items.
 * @param <K> Key Value of Entry
 * @param <V> Value of Entry
 */
public class HashMapList<K extends Comparable<K>, V extends Comparable<V>> implements KWHashMap<K, V> {
    ...
    /** Put method for class HashtableChain.
